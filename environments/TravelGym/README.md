# TravelGym - canonical package location

This is the only TravelGym source location. The Python package name remains
`travelgym`.
...
The coefficients are recorded in `data/evaluation/travel_manifest.json`.
