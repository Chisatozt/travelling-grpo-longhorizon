...
- Contributing to TravelGym, the training pipeline, and evaluation framework
...
-  If you'd like to submit a fix for a bug, [send a Pull Request](#creating_a_pull_request) and mention the Issue number.
  ...
  -  For TravelGym bugs, include a regression test for the public protocol and terminal reward.
...
-  If you'd like to implement the new feature, please wait for feedback from the project
 ...
 -  For TravelGym changes, follow [gyms/README.md](gyms/README.md) and preserve the public Search -> Action -> Answer contract.
...
-  Documentation improvements are especially welcome for TravelGym, training configurations, and evaluation procedures.
...
- [x] Tests
  ...
  - For TravelGym, include integration tests with the training pipeline.
