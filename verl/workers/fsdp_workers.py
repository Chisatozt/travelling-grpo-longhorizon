...
class RewardModelWorker(Worker):
    ...
    def _switch_chat_template(self, data: DataProto):
        ...
        for i in range(data.batch.batch_size[0]):
            ...
            template_kwargs = {"add_generation_prompt": False, "tokenize": False, "enable_thinking": True}
            try:
                prompt_with_chat_template = target_tokenizer.apply_chat_template(chat, **template_kwargs)
            except TypeError:
