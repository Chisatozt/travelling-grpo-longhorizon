...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # string
        template_kwargs = {"add_generation_prompt": True, "tokenize": False, "enable_thinking": True}
        try:
            prompt_chat_str = tokenizer.apply_chat_template(prompt_chat, **template_kwargs)
        except TypeError:
