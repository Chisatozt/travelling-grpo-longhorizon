...
CONTEXT_CLEANUP_ENABLED="${NATIVE_CONTEXT_CLEANUP_ENABLED:-${CONTEXT_CLEANUP_ENABLED:-false}}"
CONTEXT_CLEANUP_TARGET_TOKENS="${NATIVE_CONTEXT_CLEANUP_TARGET_TOKENS:-${CONTEXT_CLEANUP_TARGET_TOKENS:-20000}}"
CONTEXT_CLEANUP_TEMPLATE_MARGIN_TOKENS="${NATIVE_CONTEXT_CLEANUP_TEMPLATE_MARGIN_TOKENS:-${CONTEXT_CLEANUP_TEMPLATE_MARGIN_TOKENS:-32}}"
...
CONTEXT_CLEANUP_ENABLED="$CONTEXT_CLEANUP_ENABLED" \
CONTEXT_CLEANUP_TARGET_TOKENS="$CONTEXT_CLEANUP_TARGET_TOKENS" \
CONTEXT_CLEANUP_TEMPLATE_MARGIN_TOKENS="$CONTEXT_CLEANUP_TEMPLATE_MARGIN_TOKENS" \
